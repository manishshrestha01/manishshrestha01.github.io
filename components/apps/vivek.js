    ...
    return (
        <>
            <div className="w-20 md:w-28 my-4 bg-white rounded-full">
                <img className="w-full" src="./images/logos/bitmoji.png" alt="Manish Shrestha Logo" />
            </div>
            <div className=" mt-4 md:mt-8 text-lg md:text-2xl text-center px-1">
                <div>my name is <span className="font-bold">Manish Shrestha</span> ,</div>
            ...
            <ul className=" mt-4 leading-tight tracking-tight text-sm md:text-base w-5/6 md:w-3/4 emoji-list">
                <li className=" list-pc">I'm a <span className=" font-medium">Undergraduate Student</span> currently pursuing Computer Engineering Degree at <u className=' cursor-pointer '> <a href="https://pec.edu.np/" target={"_blank"}>Pokhara Engineering College</a> </u> ( Hit me up <a className='text-underline' href='mailto:shresthamanish8080@gmail.com'><u>@shresthamanish8080@gmail.com</u></a> :) )</li>
        ...
        <>
            ...
            <ul className=" w-10/12  mt-4 ml-4 px-0 md:px-1">
                ...
                <li className="list-disc mt-5">
                    <div className=" text-lg md:text-xl text-left font-bold leading-tight">
                        Class 12<sup>th</sup> (NEB)
                    </div>
                    <div className=" text-sm text-gray-400 mt-0.5">2020 - 2022</div>
                    <div className=" text-sm md:text-base">Maths, Physics, Chemistry, Biology</div>
                    <div className="text-sm text-gray-300 font-bold mt-1">CGPA &nbsp; 3.00/4.00</div>
                </li>
            </ul>
        </>
    )
    ...
    return (
        <>
            ...
            <div className="w-full md:w-10/12 flex justify-center items-start font-bold text-center">
                <div className="px-2 w-1/2">
                    <div className="flex flex-wrap justify-center items-start w-full mt-2">
                        ...
                        <img className="m-1" src="https://img.shields.io/badge/Dart-0175C2?style=flat&logo=dart&logoColor=white" alt="manish dart" />
            ...
            <ul className=" tracking-tight text-sm md:text-base w-10/12 emoji-list mt-4">
                <li className=" list-arrow text-sm md:text-base mt-4 leading-tight tracking-tight">
                    <span> And of course,</span> <img className=" inline ml-1" src="http://img.shields.io/badge/-Linux-0078D6?style=plastic&logo=linux&logoColor=ffffff" alt="manish linux" /> <span>!</span>
                </li>
            </ul>
        </>
    )
    ...
    const project_list = [
        {
            ...
            date: "July 2024",
            link: "https://github.com/manishshrestha01/manishshrestha01.github.io",
            description: [
                            ...
                            <div className="w-full py-1 px-2 my-2 border border-gray-50 border-opacity-10 rounded hover:bg-gray-50 hover:bg-opacity-5 cursor-pointer">
                                <div className="flex flex-wrap justify-between items-center">
                                    <div className='flex justify-center items-center'>
                                        ...
                                        <iframe src={`https://ghbtns.com/github-btn.html?user=manishshrestha01&repo=UBUNTU-OS&type=star&count=true`} frameBorder="0" scrolling="0" width="150" height="20" title={project.name.toLowerCase()+"-star"}></iframe>
                                    </div>
...
function Resume() {
    return (
        <iframe className="h-full w-full" src="./files/Manish.pdf" title="manish shrestha resume" frameBorder="0"></iframe>
    )
}