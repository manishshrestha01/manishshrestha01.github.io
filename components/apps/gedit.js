...
const USER_ID = '25rijR4Sdt4Giwpm7';
const TEMPLATE_ID = 'template_mt7bbeo';  // Updated template ID
const SERVICE_ID = 'service_0i7gkxj';
...
export class Gedit extends Component {
  ...
  sendMessage = async () => {
    ...
    let email = $("#sender-email").val();  // Changed to reflect new template variable
    ...
    const templateParams = {
      user_name: name,     // Updated parameter name
      user_email: email,   // Updated parameter name
      user_message: message // Updated parameter name
    };
    ...
    return (
      <div className="w-full h-full relative flex flex-col bg-ub-cool-grey text-white select-none">
        ...
        <div className="relative flex-grow flex flex-col bg-ub-gedit-dark font-normal windowMainScreen">
          ...
          <div className="relative">
            <input id="sender-email" className="w-full my-1 text-ubt-gedit-blue focus:bg-ub-gedit-light gedit-subject outline-none text-sm font-normal pl-6 py-0.5 bg-transparent" placeholder="Your Email :" spellCheck="false" autoComplete="off" type="text" />
